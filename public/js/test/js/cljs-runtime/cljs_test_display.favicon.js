...
return html_coll.item(p1__35584_SHARP_);
...
return cljs.core.some((function (p1__35586_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__35586_SHARP_);
...
var ctx_35602 = cvs.getContext("2d");
(ctx_35602.fillStyle = color);

ctx_35602.fillRect((0),(0),size,size);
