...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28759 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28759(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28765 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28765(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28770 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28770(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28772 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28772(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28774 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28774(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28779 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28779(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28788 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28788(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28790 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28790(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28792 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28792(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28793 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28793(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28796 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28796(b);
}
});
