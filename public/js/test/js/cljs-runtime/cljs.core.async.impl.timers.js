...
var i_29106 = (0);
while(true){
if((i_29106 < arr.length)){
(arr[i_29106] = null);

var G__29107 = (i_29106 + (1));
i_29106 = G__29107;
continue;
} else {
}
...
var i_29129 = (self__.level + (1));
while(true){
if((i_29129 <= (new_level + (1)))){
(update[i_29129] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29132 = (update[i]).forward;
(x__$2.forward[i] = (links_29132[i]));
...
var i_29135 = (0);
while(true){
if((i_29135 <= self__.level)){
var links_29136 = (update[i_29135]).forward;
if((x__$1 === (((i_29135 < links_29136.length))?(links_29136[i_29135]):null))){
(links_29136[i_29135] = (x__$1.forward[i_29135]));

var G__29163 = (i_29135 + (1));
i_29135 = G__29163;
continue;
} else {
var G__29164 = (i_29135 + (1));
i_29135 = G__29164;
continue;
}
} else {
