...
var map__111752 = cljs.core.deref(hpointu.rts.input.mouse);
var map__111752__$1 = (((((!((map__111752 == null))))?(((((map__111752.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__111752.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__111752):map__111752);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111752__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111752__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
...
document.addEventListener("keydown",(function (p1__111754_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(hpointu.rts.input.keymap,cljs.core.conj,p1__111754_SHARP_.code);
}));

document.addEventListener("keyup",(function (p1__111755_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(hpointu.rts.input.keymap,cljs.core.disj,p1__111755_SHARP_.code);
}));
...
return document.addEventListener("mousemove",(function (p1__111756_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(hpointu.rts.input.mouse,cljs.core.assoc,new cljs.core.Keyword(null,"x","x",2099068185),p1__111756_SHARP_.clientX,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"y","y",-1757859776),p1__111756_SHARP_.clientY], 0));
}));
});
