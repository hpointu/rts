...
var r = (new RegExp(re.source,(function (){var G__26526 = "g";
var G__26526__$1 = (cljs.core.truth_(re.ignoreCase)?[G__26526,"i"].join(''):G__26526);
var G__26526__$2 = (cljs.core.truth_(re.multiline)?[G__26526__$1,"m"].join(''):G__26526__$1);
if(cljs.core.truth_(re.unicode)){
return [G__26526__$2,"u"].join('');
} else {
return G__26526__$2;
}
})()));
...
while (G__26544__i < G__26544__a.length) {G__26544__a[G__26544__i] = arguments[G__26544__i + 0]; ++G__26544__i;}
  args = new cljs.core.IndexedSeq(G__26544__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26545);
...
while(true){
if((!((coll__$1 == null)))){
var G__26557 = sb.append(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(coll__$1)));
var G__26558 = cljs.core.next(coll__$1);
sb = G__26557;
coll__$1 = G__26558;
continue;
} else {
...
var G__26566 = cljs.core.pop(v__$1);
v__$1 = G__26566;
continue;
} else {
return v__$1;
...
var pred__26532 = cljs.core._EQ__EQ_;
var expr__26533 = limit;
...
var G__26568 = s__$1.substring((index + cljs.core.count(m)));
var G__26569 = (limit__$1 - (1));
var G__26570 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__26568;
limit__$1 = G__26569;
parts = G__26570;
continue;
