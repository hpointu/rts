...
var G__27068 = o;
goog.object.set(G__27068,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__27087__i < G__27087__a.length) {G__27087__a[G__27087__i] = arguments[G__27087__i + 0]; ++G__27087__i;}
  args = new cljs.core.IndexedSeq(G__27087__a,0,null);
} 
...
var G__27069 = o;
goog.object.set(G__27069,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27070__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27071 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27071,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27071;
}
})(),id_class);
...
var G__27072 = (cljs.core.count(argv) - first_child);
switch (G__27072) {
case (0):
...
var vec__27073 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27073,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27073,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27073,(2),null);
...
var temp__5739__auto___27112 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27112 == null)){
} else {
var key_27113 = temp__5739__auto___27112;
(jsprops.key = key_27113);
}
...
var temp__5739__auto___27115 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27115 == null)){
} else {
var key_27116 = temp__5739__auto___27115;
(jsprops.key = key_27116);
}
...
var temp__5739__auto___27123 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___27123 == null)){
} else {
var key_27125 = temp__5739__auto___27123;
(jsprops.key = key_27125);
}
...
var temp__5739__auto___27129 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27129 == null)){
} else {
var key_27130 = temp__5739__auto___27129;
(jsprops.key = key_27130);
}
...
var temp__5739__auto___27131 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27131 == null)){
} else {
var key_27132 = temp__5739__auto___27131;
(jsprops.key = key_27132);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27076_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27076_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27077 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27077,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27077,(1),null);
...
break;
default:
var G__27141 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27142 = compiler;
v = G__27141;
compiler = G__27142;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27083 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27083 = (function (opts,id,fn_to_element,meta27084){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27083.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27085,meta27084__$1){
var self__ = this;
var _27085__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27083(self__.opts,self__.id,self__.fn_to_element,meta27084__$1));
}));

(reagent.impl.template.t_reagent$impl$template27083.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27085){
var self__ = this;
var _27085__$1 = this;
return self__.meta27084;
}));

(reagent.impl.template.t_reagent$impl$template27083.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27083.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27083.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27083.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27083.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta27084","meta27084",655069657,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27083.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27083.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27083");

(reagent.impl.template.t_reagent$impl$template27083.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template27083");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27083.
 */
reagent.impl.template.__GT_t_reagent$impl$template27083 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27083(opts__$1,id__$1,fn_to_element__$1,meta27084){
return (new reagent.impl.template.t_reagent$impl$template27083(opts__$1,id__$1,fn_to_element__$1,meta27084));
});

}

return (new reagent.impl.template.t_reagent$impl$template27083(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
