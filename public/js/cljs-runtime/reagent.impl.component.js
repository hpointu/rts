...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26941 = c;
var G__26941__$1 = (((G__26941 == null))?null:G__26941.prototype);
if((G__26941__$1 == null)){
return null;
} else {
return G__26941__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26945 = c;
var G__26945__$1 = (((G__26945 == null))?null:G__26945.prototype);
if((G__26945__$1 == null)){
return null;
} else {
return G__26945__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__26952 = c;
var G__26952__$1 = (((G__26952 == null))?null:G__26952.constructor);
if((G__26952__$1 == null)){
return null;
} else {
return G__26952__$1.displayName;
}
})();
...
var G__26953 = c;
var G__26953__$1 = (((G__26953 == null))?null:G__26953.constructor);
if((G__26953__$1 == null)){
return null;
} else {
return G__26953__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__26954 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26955 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26955);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26954);
}});
...
var c = this;
var G__26968_27058 = goog.object.get(c,"cljsRatom");
if((G__26968_27058 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26968_27058);
}
...
var renders_27060 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27061 = cljs.core.first(cljs.core.vals(renders_27060));
...
if((cljs.core.count(renders_27060) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27060))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27061)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27061], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26972 = o;
goog.object.set(G__26972,cljs.core.name(k),v);
...
return (function() { 
var G__27063__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__27063 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27064__i = 0, G__27064__a = new Array(arguments.length -  0);
while (G__27064__i < G__27064__a.length) {G__27064__a[G__27064__i] = arguments[G__27064__i + 0]; ++G__27064__i;}
  args = new cljs.core.IndexedSeq(G__27064__a,0,null);
} 
return G__27063__delegate.call(this,args);};
G__27063.cljs$lang$maxFixedArity = 0;
G__27063.cljs$lang$applyTo = (function (arglist__27065){
var args = cljs.core.seq(arglist__27065);
...
var _STAR_current_component_STAR__orig_val__27009 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27010 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27010);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27009);
}});
...
var vec__27016 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27016,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27016,(1),null);
...
var G__27035 = goog.object.get(reagent_state,"cljsRatom");
if((G__27035 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__27035);
}
});
}),[]);
